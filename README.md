...
Code structure
Using VS Code as my IDE I create a solution with a source folder for the JavaScript files, I also create a distribution folder for the files generated by WebPack
...
I have the following four files in the WebResources\Js folder, containing the code for two forms related to the OOTB Account table:
